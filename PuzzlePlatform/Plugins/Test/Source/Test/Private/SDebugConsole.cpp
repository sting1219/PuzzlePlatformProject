...
void SDebugConsole::Construct( const FArguments& InArgs, const EDebugConsoleStyle::Type InStyle, FTestModule* OutputLogModule, const FDebugConsoleDelegates* DebugConsoleDelegates )
{
