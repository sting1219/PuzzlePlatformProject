...
//
//#define LOCTEXT_NAMESPACE "TestOutputLog"
...
//	if (TestOutputLog::CreateLogMessages(InText, InVerbosity, InCategory, NewMessages))
//	{
...
//
//BEGIN_SLATE_FUNCTION_BUILD_OPTIMIZATION
//void TestOutputLog::Construct(const FArguments& InArgs)
//{
...
//		.OnVScrollBarUserScrolled(this, &TestOutputLog::OnUserScrolled)
//		.ContextMenuExtender(this, &TestOutputLog::ExtendTextBoxMenu);
//
//	ChildSlot
//		[
//			SNew(SBorder)
...
//		.OnGetMenuContent(this, &TestOutputLog::MakeAddFilterMenu)
//		.HasDownArrow(true)
...
//		.OnTextChanged(this, &TestOutputLog::OnFilterTextChanged)
//		.OnTextCommitted(this, &TestOutputLog::OnFilterTextCommitted)
...
//			.OnConsoleCommandExecuted(this, &TestOutputLog::OnConsoleCommandExecuted)
//
...
//	FCoreDelegates::OnHandleSystemError.AddRaw(this, &TestOutputLog::OnCrash);
//
...
//}
//
//bool TestOutputLog::CreateLogMessages(const TCHAR* V, ELogVerbosity::Type Verbosity, const class FName& Category, TArray< TSharedPtr<FOutputLogMessage> >& OutMessages)
//{
...
//}
//
//void TestOutputLog::Serialize(const TCHAR* V, ELogVerbosity::Type Verbosity, const class FName& Category)
//{
...
//}
//
//void TestOutputLog::ExtendTextBoxMenu(FMenuBuilder& Builder)
//{
//	FUIAction ClearOutputLogAction(
//		FExecuteAction::CreateRaw(this, &TestOutputLog::OnClearLog),
//		FCanExecuteAction::CreateSP(this, &TestOutputLog::CanClearLog)
//	);
//
...
//}
//
//void TestOutputLog::OnUserScrolled(float ScrollOffset)
//{
//	bIsUserScrolled = ScrollOffset < 1.0 && !FMath::IsNearlyEqual(ScrollOffset, 1.0f);
//}
//
//bool TestOutputLog::CanClearLog() const
//{
//	return MessagesTextMarshaller->GetNumMessages() > 0;
//}
//
//void TestOutputLog::OnConsoleCommandExecuted()
//{
//	RequestForceScroll();
//}
//
//void TestOutputLog::RequestForceScroll()
//{
...
//}
//
//void TestOutputLog::OnFilterTextChanged(const FText& InFilterText)
//{
...
//}
//
//void TestOutputLog::OnFilterTextCommitted(const FText& InFilterText, ETextCommit::Type InCommitType)
//{
//	OnFilterTextChanged(InFilterText);
//}
//
//TSharedRef<SWidget> TestOutputLog::MakeAddFilterMenu()
//{
//	FMenuBuilder MenuBuilder(/*bInShouldCloseWindowAfterMenuSelection=*/true, nullptr);
//
...
//			FSlateIcon(),
//			FUIAction(FExecuteAction::CreateSP(this, &TestOutputLog::VerbosityLogs_Execute),
//				FCanExecuteAction::CreateLambda([] { return true; }),
//				FIsActionChecked::CreateSP(this, &TestOutputLog::VerbosityLogs_IsChecked)),
//			NAME_None,
...
//			FSlateIcon(),
//			FUIAction(FExecuteAction::CreateSP(this, &TestOutputLog::VerbosityWarnings_Execute),
//				FCanExecuteAction::CreateLambda([] { return true; }),
//				FIsActionChecked::CreateSP(this, &TestOutputLog::VerbosityWarnings_IsChecked)),
//			NAME_None,
//			EUserInterfaceActionType::ToggleButton
//		);
//
...
//			FSlateIcon(),
//			FUIAction(FExecuteAction::CreateSP(this, &TestOutputLog::VerbosityErrors_Execute),
//				FCanExecuteAction::CreateLambda([] { return true; }),
//				FIsActionChecked::CreateSP(this, &TestOutputLog::VerbosityErrors_IsChecked)),
//			NAME_None,
//			EUserInterfaceActionType::ToggleButton
//		);
//	}
...
//			FNewMenuDelegate::CreateSP(this, &TestOutputLog::MakeSelectCategoriesSubMenu)
//		);
//	}
//
//	return MenuBuilder.MakeWidget();
//}
//
//void TestOutputLog::MakeSelectCategoriesSubMenu(FMenuBuilder& MenuBuilder)
//{
...
//			FSlateIcon(),
//			FUIAction(FExecuteAction::CreateSP(this, &TestOutputLog::CategoriesShowAll_Execute),
//				FCanExecuteAction::CreateLambda([] { return true; }),
//				FIsActionChecked::CreateSP(this, &TestOutputLog::CategoriesShowAll_IsChecked)),
//			NAME_None,
//			EUserInterfaceActionType::ToggleButton
//		);
//
...
//				FSlateIcon(),
//				FUIAction(FExecuteAction::CreateSP(this, &TestOutputLog::CategoriesSingle_Execute, Category),
//					FCanExecuteAction::CreateLambda([] { return true; }),
//					FIsActionChecked::CreateSP(this, &TestOutputLog::CategoriesSingle_IsChecked, Category)),
//				NAME_None,
//				EUserInterfaceActionType::ToggleButton
//			);
//		}
...
//}
//
//bool TestOutputLog::VerbosityLogs_IsChecked() const
//{
//	return Filter.bShowLogs;
//}
//
//bool TestOutputLog::VerbosityWarnings_IsChecked() const
//{
//	return Filter.bShowWarnings;
//}
//
//bool TestOutputLog::VerbosityErrors_IsChecked() const
//{
//	return Filter.bShowErrors;
//}
//
//void TestOutputLog::VerbosityLogs_Execute()
//{
...
//}
//
//void TestOutputLog::VerbosityWarnings_Execute()
//{
...
//}
//
//void TestOutputLog::VerbosityErrors_Execute()
//{
...
//}
//
//bool TestOutputLog::CategoriesShowAll_IsChecked() const
//{
//	return Filter.bShowAllCategories;
//}
//
//bool TestOutputLog::CategoriesSingle_IsChecked(FName InName) const
//{
//	return Filter.IsLogCategoryEnabled(InName);
//}
//
//void TestOutputLog::CategoriesShowAll_Execute()
//{
...
//}
//
//void TestOutputLog::CategoriesSingle_Execute(FName InName)
//{
